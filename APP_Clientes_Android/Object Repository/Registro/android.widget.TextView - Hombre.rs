...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Hombre</name>
   <tag></tag>
   <elementGuidId>f57d72f6-5b13-410e-91de-a8c0d9c7517f</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = '${sexo}' or . = '${sexo}')]</locator>
